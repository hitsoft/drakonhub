				...
				<tr style="height:60px;">
					...
					<td style="width:100%; text-align:right;">
						% if content_path ~= "signup" then
							...
							% if not on_premises and content_path ~= "signup" and content_path ~= "logon" and content_path ~= "start-drakon" and content_path ~= "start-mind-map" and content_path ~= "signup-trial" and content_path ~= "trial" then
